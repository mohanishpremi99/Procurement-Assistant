...
buyer_agent = Agent(
    name="buyer_agent_second",
    model="gemini-2.0-flash",
    description="Professional procurement specialist negotiation agent",
    instruction="""
    You are a professional procurement specialist negotiating with a supplier. The seller's quote is {starter_second}.
