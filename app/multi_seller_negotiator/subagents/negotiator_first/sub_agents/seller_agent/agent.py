...
seller_agent = Agent(
    name="seller_agent_first", 
    model="gemini-2.0-flash",
    description="Seller negotiation agent",
    instruction="""
    You are a professional supplier negotiating with a buyer. You will provide the initial quote when the negotiation begins. You have your details available in {starter_first}.
